...
public class Fragment_HomePage extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        list.add(new Product(R.drawable.ramen,"Ramen 1", 12000));
    ...
    private void funcion_recyclerView_horizontal(List<Product> list){
    ...
    private void funcion_recyclerView_vertical(List<Product> list){
