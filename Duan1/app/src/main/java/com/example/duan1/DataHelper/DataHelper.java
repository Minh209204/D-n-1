...
public class DataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String thongke = "CREATE TABLE THONGKE(MATK tINTEGER NOT NULL, MASP INTEGER, SOLUONG INTEGER, PRIMARY KEY(MATK), FOREIGN KEY(MASP) REFERENCES HOADON(MASP), FOREIGN KEY(SOLUONG) REFERENCES HOADON(SOLUONG));";
